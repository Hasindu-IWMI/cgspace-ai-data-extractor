...
class MainApp:
    def __init__(self):
        self.config = Config()
        self.config.running_event.set()  # Set running_event to true by default
        self.logger = Logger()
        self.ai_handler = AIHandler(self.config, "Gemini", "")  # API key will be set dynamically
